...
async function main() {
  console.log('🚀 Deploying clean contract to Somnia Testnet...');
  ...
  try {
    console.log('📦 Deploying clean contract...');
    
    // Clean contract bytecode (this is a basic storage contract)
    ...
    console.log('\n📊 Deployment Summary:');
    console.log('=========================');
    console.log('Contract: CleanContract');
