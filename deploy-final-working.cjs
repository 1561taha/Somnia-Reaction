...
async function main() {
  console.log('🚀 Deploying final working contract to Somnia Testnet...');
  ...
  try {
    ...
    // Final working contract bytecode (this is a basic storage contract)
    ...
    console.log('\n📊 Deployment Summary:');
    console.log('=========================');
    console.log('Contract: FinalWorkingContract');
